...
/** Emblema real de Omega — PNG único, no depende del tier. */
const LOGO_SRC = '/assets/omega-logo.png';

/**
 * Logo de Omega usado en toda la app (sidebar, chat, modales, pantallas de
 * auth). Intenta el PNG real primero; si no existe o falla la carga, cae en
 * los dos anillos SVG + glifo "Ω" en Cinzel que ya cumplían esta función —
 * nunca se ve roto ni en blanco.
 */
