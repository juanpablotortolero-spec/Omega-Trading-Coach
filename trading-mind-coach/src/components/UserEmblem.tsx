...
/**
 * El avatar de identidad del usuario: dos anillos SVG dorados (el marco que
 * lo hace leerse como una insignia circular, no una letra suelta) detrás de
 * un glifo Cinzel con relleno degradado, más el mismo resplandor pulsante
 * dorado que el logo de Omega y los rangos Virtus (mission-badge-pulse).
 */
